...
namespace DatabaseComponent
{
	...
	public class MRCListDB
	{
        ...
        public MRCListDB(string connectionString)
		{
        ...
        public List<MRCListDetails> GetMRCDetail(string mrcid)
		{
			SqlConnection con = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand("GetMRCDetail", con);
			cmd.CommandType = CommandType.StoredProcedure;
            ...
            List<MRCListDetails> mrcDetails = new List<MRCListDetails>();
			...
			try 
			{
				...
				while (reader.Read())
				{
                    MRCListDetails mrcDetail = new MRCListDetails(
                        (string)reader["MrcDeID"],
                        (string)reader["MrcID"],
                        (string)reader["MrcCode"],
                        (string)reader["CustomerName"],
                        (string)reader["PlateNo"],                        
                        (string)reader["Comment"]
                        );
                    mrcDetails.Add(mrcDetail);
				}
